...
public class Player {
    private String name;
    private int unAssignedtroops;
    private int id;//provide index for players in Game
    private HashMap<String,Territory> territoryList;//for Searching purpose reserved
    private LinkedList<Territory> territoryLinkedList;//for iteration purpose and manipulation
    ...
    public Player(String name)
    {
        ...
        this.name = name;
        territoryLinkedList = new LinkedList<>();
    }
     ...
     * @param num
     */
    public void increaseUnassignedTroops(int num)
    {
        unAssignedtroops+=num;
    }
     ...
     * @param num
     */
    public void decreaseUnassignedTroops(int num)
    {
        unAssignedtroops -= num;
    }
    ...
    public void removeTerritory(Territory territory){
        territoryLinkedList.remove(territory);

    }
    public void addTerritory(Territory territory){
        territoryLinkedList.add(territory);
    ...
    public LinkedList<Territory> getTerritoryLinkedList() {
        return territoryLinkedList;
    }
    ...
    public String printPlayerinfo()
    {
        String result = "";
        result += name + "\n";
        for (Territory t : territoryLinkedList)
        {
            result += " ";
            result+=t.getName()+" "+t.getTroops()+"\n";
        }
        result+="You have "+ unAssignedtroops + " troops available to draft";
        return result;
    }

    public boolean checkTerritoryByString(String countryName) {
        for(Territory territory: territoryLinkedList){
