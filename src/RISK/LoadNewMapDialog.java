...
public class LoadNewMapDialog {
    ...
    private MapType[] type = {MapType.Classic,MapType.Seaport,MapType.Invalid_Isolated_Territory,MapType.Invalid_Isolated_Groups};
    ...
    enum MapType{
        Classic("OriginRiskMap"),Seaport("Map1"),Invalid_Isolated_Territory("Invalid1"),Invalid_Isolated_Groups("Invalid2"),;
